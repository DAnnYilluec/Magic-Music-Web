...
@section('content')
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <h2>Crear Discusion</h2>
        <form action="{{route('discusionEditar',$id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
        <div class="row mb-4">
            <input class="col-12 tm-text-primary" placeholder="Titulo de la Discusión" name="titulo" value="{{$id->titulo}}">
        </div>
