...
<nav class="navbar navbar-expand-lg" style="background-color: Orange;">
    <div class="container-fluid">
        <a class="navbar-brand titulo" href="{{ route('inicio') }}" style="color: white;">
            MAGICAL MUSIC WEB
        </a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <i class="fas fa-bars"></i>
        </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="background-color: Orange;">
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link-ad" aria-current="page" href="{{ route('inicio') }}">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link-ad" href="{{ route('pagPublicaciones') }}">Publicaciones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link-ad" href="{{ route('pagDiscusiones') }}">Discusiones</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link-ad" href="{{ route('pagArtistas') }}">Artistas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link-ad" href="{{ route('panelAdmin') }}">Administrador</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link-ad" href="{{ route('miPerfil', ['id' => Auth::id()]) }}">Mi Perfil</a>
                </li>
            </ul>
        </div>
    </div>
