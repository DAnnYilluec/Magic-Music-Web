...
@section('content')
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        ...
        <form action="{{route('crearDiscusion')}}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="row mb-4">
            <input class="col-12 tm-text-primary" placeholder="Titulo de la Discusión" name="titulo">
        </div>
