...
@section('content')
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <h2>Crear Artista</h2>
        <form action="{{route('crearArtista')}}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="row mb-4">
            <input class="col-12 tm-text-primary" placeholder="Nombre del Grupo o Cantante" name="nombre">
        </div>
